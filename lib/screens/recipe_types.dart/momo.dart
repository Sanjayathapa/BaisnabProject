...
class ListItem {
  ...
  factory ListItem.fromSnapshot(DocumentSnapshot snapshot) {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final foodItem = foodItems1[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems1: foodItems1, index:0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<ListItem> foodItems1;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems1,
     required this.index,
    required List<ListItem> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems1[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
...
class AddToCartPage extends StatelessWidget {
  ...
  const AddToCartPage({Key? key, required this.foodItems1,
   required this.index,}) : super(key: key);
  
  
Future<void> addToCart(BuildContext context, List<ListItem> foodItems1) async {
  final FirestoreService _firestoreService = FirestoreService();
  final FirebaseFirestore firestore = FirebaseFirestore.instance;
  final String documentId = 'X3gL3CASwLwTscI6tM19'; // Replace with your desired document ID

  try {
    for (var foodItem in foodItems1) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems1 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<ListItem> foodItems1 = snapshot.data!.docs.map((doc) {
              return ListItem(
