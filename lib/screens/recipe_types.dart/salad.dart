...
class RecipeIt{
 ...
 RecipeIt({
  ...
  factory RecipeIt.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory RecipeIt.fromMap(Map<String, dynamic> map) {
    return RecipeIt(
  ...
  factory RecipeIt.fromJson(String source) =>
     RecipeIt.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: foodItems4.length,
                  itemBuilder: (context, index) {
                    final foodItem = foodItems4[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems4:foodItems4, index: 0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<RecipeIt> foodItems4;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems4,
     required this.index,
    required List<RecipeIt> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems4[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems4[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Reading Time: ${foodItems4[index].readingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems4[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  final List<RecipeIt> foodItems4;
  final int index;
  const AddToCartPage({Key? key, required this.foodItems4
  ,required this.index
  }) : super(key: key);
  
  

  Future<void> addToCart(BuildContext context, List<RecipeIt> foodItems4) async {
    ...
    final String documentId =
     ...
     try {
    for (var foodItem in foodItems4) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems4 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<RecipeIt> foodItems4= snapshot.data!.docs.map((doc) {
              return RecipeIt(
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                deleteFromCart( foodItems4[index].recipeTitle).then((_) {
                              // Remove the item from the list
                              foodItems4.removeAt(index);
                            }),
                          ),
                        ],
                      ),
