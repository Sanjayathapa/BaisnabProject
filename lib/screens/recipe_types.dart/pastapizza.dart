...
class RecipeItem {
 ...
 RecipeItem({
  ...
  factory RecipeItem.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory RecipeItem.fromJson(String source) =>
     RecipeItem.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: foodItems2.length,
                  itemBuilder: (context, index) {
                    final foodItem = foodItems2[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems2:foodItems2, index: 0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<RecipeItem> foodItems2;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems2,
     required this.index,
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems2[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems2[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Reading Time: ${foodItems2[index].readingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems2[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  final List<RecipeItem> foodItems2;
  final int index;
  const AddToCartPage({Key? key, required this.foodItems2
  ,required this.index
  }) : super(key: key);
  
  

  Future<void> addToCart(BuildContext context, List<RecipeItem> foodItems2) async {
    ...
    final String documentId =
     ...
     try {
    for (var foodItem in foodItems2) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems2 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<RecipeItem> foodItems2 = snapshot.data!.docs.map((doc) {
              return RecipeItem(
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                deleteFromCart( foodItems2[index].recipeTitle).then((_) {
