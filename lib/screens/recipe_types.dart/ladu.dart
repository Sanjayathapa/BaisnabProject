...
RecipeI({
  ...
  factory RecipeI.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory RecipeI.fromMap(Map<String, dynamic> map) {
    return RecipeI(
  ...
  factory RecipeI.fromJson(String source) =>
     RecipeI.fromMap(json.decode(source) as Map<String, dynamic>);
}

class LaduuPage extends StatelessWidget {
 LaduuPage({super.key});
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount:  foodItems5.length,
                  itemBuilder: (context, index) {
                    final foodItem =  foodItems5[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [],  foodItems5: foodItems5, index: 0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<RecipeI> foodItems5;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems5,
     required this.index,
    required List<RecipeI> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems5[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems5[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Reading Time: ${foodItems5[index].readingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems5[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  final List<RecipeI> foodItems5;
  final int index;
  const AddToCartPage({Key? key, required this.foodItems5
  ,required this.index
  }) : super(key: key);
  
  

  Future<void> addToCart(BuildContext context, List<RecipeI> foodItems5) async {
    ...
    final String documentId =
     ...
     try {
    for (var foodItem in foodItems5) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems5 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<RecipeI> foodItems5 = snapshot.data!.docs.map((doc) {
              return RecipeI(
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                deleteFromCart( foodItems5[index].recipeTitle).then((_) {
                              // Remove the item from the list
                              foodItems2.removeAt(index);
                            }),
                          ),
                        ],
                      ),
