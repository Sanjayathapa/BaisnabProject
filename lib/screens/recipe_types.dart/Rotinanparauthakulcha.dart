...
class RecipeIte {
 ...
 RecipeIte({
  ...
  factory RecipeIte.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory RecipeIte.fromMap(Map<String, dynamic> map) {
    return RecipeIte(
  ...
  factory RecipeIte.fromJson(String source) =>
     RecipeIte.fromMap(json.decode(source) as Map<String, dynamic>);
}

class Rotinan extends StatelessWidget {
 Rotinan({super.key});
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: foodItems3.length,
                  itemBuilder: (context, index) {
                    final foodItem = foodItems3[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems3:foodItems3, index: 0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<RecipeIte> foodItems3;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems3,
     required this.index,
    required List<RecipeIte> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems3[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems3[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems3[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  final List<RecipeIte> foodItems3;
  final int index;
  const AddToCartPage({Key? key, required this.foodItems3
  ,required this.index
  }) : super(key: key);
  
  

  Future<void> addToCart(BuildContext context, List<RecipeIte> foodItems3) async {
    ...
    final String documentId =
     ...
     try {
    for (var foodItem in foodItems3) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems3 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<RecipeIte> foodItems3 = snapshot.data!.docs.map((doc) {
              return RecipeIte(
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                deleteFromCart( foodItems3[index].recipeTitle).then((_) {
                              // Remove the item from the list
                              foodItems3.removeAt(index);
                            }),
                          ),
                        ],
                      ),
