...
class Contained {
  ...
  factory Contained.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory Contained.fromMap(Map<String, dynamic> map) {
    return Contained(
  ...
  factory Contained.fromJson(String source) =>
      Contained.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: foodItems6.length,
                  itemBuilder: (context, index) {
                    final foodItem = foodItems6[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems6: foodItems6, index:0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List<Contained> foodItems6;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems6,
     required this.index,
    required List<Contained> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems6[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems6[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Reading Time: ${foodItems1[index].readingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems6[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  ...
  const AddToCartPage({Key? key, required this.foodItems6,
   required this.index,}) : super(key: key);
  
  
Future<void> addToCart(BuildContext context, List<Contained> foodItems6) async {
  final FirestoreService _firestoreService = FirestoreService();
  final FirebaseFirestore firestore = FirebaseFirestore.instance;
  final String documentId = 'X3gL3CASwLwTscI6tM19'; // Replace with your desired document ID

  try {
    for (var foodItem in foodItems6) {
      await firestore.collection('cart').doc(documentId).set(foodItem.toMap());
    }
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems6 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List<Contained> foodItems6 = snapshot.data!.docs.map((doc) {
              return Contained(
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                deleteFromCart(recipe.recipeTitle).then((_) {
                              // Remove the item from the list
                              foodItems6.removeAt(index);
                            }),
                          ),
                        ],
                      ),
                          ...
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor: Colors
                                  .greenAccent, // Set the background color
                              foregroundColor:
