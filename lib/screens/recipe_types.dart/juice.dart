...
class   Contain {
  ...
  factory  Contain.fromSnapshot(DocumentSnapshot snapshot) {
  ...
  factory  Contain.fromMap(Map<String, dynamic> map) {
    return  Contain(
  ...
  factory  Contain.fromJson(String source) =>
       Contain.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
//  GoogleFonts.lato
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: foodItems7.length,
                  itemBuilder: (context, index) {
                    final foodItem = foodItems7[index];
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            ...
                            builder: (context) => RecipeDetPage(
                                recipes: [], foodItems7: foodItems7, index:0,),
                          ),
                        );
                      },
                      child: Column(
...
class RecipeDetPage extends StatelessWidget {
   final List< Contain> foodItems7;
  final int index;
  RecipeDetPage({
    Key? key,
    required this.foodItems7,
     required this.index,
    required List< Contain> recipes,
  }) : super(key: key);
...
// GoogleFonts.lato
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Recipe title: ${foodItems7[index].recipeTitle}',
                style: const TextStyle(
                  fontSize: 23,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Cooking Time: ${foodItems1[index].cookingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 8),
              Text(
                'Reading Time: ${foodItems7[index].readingTime}',
                style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                ),
              ...
              const SizedBox(height: 16),
              Text(
                'Descriptions:${foodItems1[index].description}',
                style: const TextStyle(
                  fontSize: 18,
...
class AddToCartPage extends StatelessWidget {
  ...
  const AddToCartPage({Key? key, required this.foodItems7,
   required this.index,}) : super(key: key);
  
  
Future<void> addToCart(BuildContext context, List< Contain> foodItems7) async {
  final FirestoreService _firestoreService = FirestoreService();
  final FirebaseFirestore firestore = FirebaseFirestore.instance;
  final String documentId = 'X3gL3CASwLwTscI6tM19'; // Replace with your desired document ID

  try {
    for (var foodItem in foodItems7) {
              ...
              Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      await addToCart(context, foodItems7 );
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CartPage(
      ...
      child: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            List< Contain> foodItems7 = snapshot.data!.docs.map((doc) {
              return  Contain(
